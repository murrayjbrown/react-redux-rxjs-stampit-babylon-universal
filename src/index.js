    ...
    return (
      <html lang="en-us">
        <head>
          ...
          {/* styles (will be present only in p roduction with webpack extract text plugin) */}
          ...
          {/* eslint-disable */
            Object.keys(assets.styles).length === 0 ? <style type="text/css" dangerouslySetInnerHTML={{
